...
// 蝶々 L.Sautereau 01
// -------------------------------------------------------------------------------------
//   x = a*(sin(5t)±3*cos(t))*cos(t)
//   y = a*(sin(5t)±3*cos(t))*sin(t)
// -------------------------------------------------------------------------------------
// https://www.mathcurve.com/courbes2d/ornementales/ornementales.shtml
// -------------------------------------------------------------------------------------
// 2019.05.25
// -------------------------------------------------------------------------------------
class ButterflySautereau01Drawable: MyDrawable() {
    ...
    private fun createPath() {
        ...
        (0..360 step 1).forEach {
            ...
            val sin5 = MyMathUtil.sinf(5*t)
            val x = a*(sin5+3*cos1)*cos1
            val y = a*(sin5+3*cos1)*sin1
