...
// 2019.06.28
// --------------------------------------------------
class Cochleoid01Drawable: MyDrawable() {

    // -------------------------------
    // 描画領域
    // -------------------------------
    private val side = 150f
    ...
    private var angleMin = -360f
    private var angle = angleMin
    ...
    private fun createPath() {
        ...
        (-360..360 step 1).forEach {
            val t = it.toFloat()
            val cos1 = MyMathUtil.cosf(t)
            val sin1 = MyMathUtil.sinf(t)
            if ( it == 0 ) {
                pointLst.add(MyPointF(a*MyMathUtil.sinf(1f),0f))
            }
            else {
                val x = a*(sin1/t)*cos1
                val y = a*(sin1/t)*sin1
