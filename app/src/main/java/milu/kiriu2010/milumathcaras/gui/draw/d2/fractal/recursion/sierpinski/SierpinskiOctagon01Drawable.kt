...
// -----------------------------------------------------------------
class SierpinskiOctagon01Drawable: MyDrawable() {
    // -------------------------------------
    // 描画領域
    // -------------------------------------
    ...
    private fun calNextLevel(polygon0:Polygon, n: Int) {
        ...
        // 次の八角形の半径 = 前の八角形の半径 * 1/(2+sqrt(2))
        val rN = polygon0.r /(2f+sqrt(2f))
        ...
        // 次の八角形の中心 =
        //    "前の八角形の中心" +
        //    "前の八角形の半径-次の八角形の半径"を45度ずつ回転させた位置
        // -------------------------------------------------------------------------
        (0..7).forEach {
    ...
    private class Polygon {
        ...
        var r: Float = 0f
            set(data: Float) {
                field = data
                (0..7).forEach {
                    val x = data*MyMathUtil.cosf(it.toFloat()*45f)
                    val y = data*MyMathUtil.sinf(it.toFloat()*45f)
