...
// -------------------------------------------------------------------------------------
class Heart01Drawable: MyDrawable() {
    ...
    private fun createPath() {
        ...
        (0..360 step 1).forEach {
            ...
            val cos2 = MyMathUtil.cosf(2f*t)
            val cos3 = MyMathUtil.cosf(3f*t)
            val cos4 = MyMathUtil.cosf(4f*t)
            val sin1 = MyMathUtil.sinf(t)
            val x = a*(16f*sin1*sin1*sin1)
            val y = a*(13f*cos1-5f*cos2-2f*cos3-cos4)
