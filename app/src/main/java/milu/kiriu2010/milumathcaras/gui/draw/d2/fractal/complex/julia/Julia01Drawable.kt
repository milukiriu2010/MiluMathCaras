package milu.kiriu2010.milumathcaras.gui.draw.d2.fractal.complex.julia
...
// Zn+1 = Zn^2 + c
// Z0 = 0
// g=>無限大で発散しないという条件を満たす複素数c全体が作る集合
// ---------------------------------------------------------------------
// X軸:実数 -1.5～0.5
// Y軸:虚数 -1.5～1.5
// の描画例をよくみかける
...
// を1スレッドの単位とする
// ---------------------------------------------------------------------
class Julia01Drawable: MyDrawable() {
    // -------------------------------
    // 描画領域
    // -------------------------------
    //  1 pixel = 0.001単位で描画
    ...
    // ジュリア集合の初期値
    // -------------------------------------
    private var complex = Complex(-0.7,0.27015)
    //private var complex = Complex(-0.4,0.6)
