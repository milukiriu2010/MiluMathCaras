...
// 2019.06.14
// -----------------------------------------------
class KochSnowflake04Drawable: MyDrawable() {
    // ---------------------------------
    // 描画領域
    // ---------------------------------
    // "線分を3等分し、中央は正三角形を生成"
    ...
    // 位相
    // ----------------------------------------
    private var phaseMax = 1f
    private var phaseMin = 0f
    private var phaseNow = phaseMin
    private var phaseDv  = 0.02f
    ...
    private val dotPath = Path().apply {
        // CW:時計回り
        addCircle(0f, 0f, 30f, Path.Direction.CW)
    }
    ...
    private fun drawBitmap() {
        ...
        // コッホ雪片を描画
        val bunchSize = myTurtleLst.size
