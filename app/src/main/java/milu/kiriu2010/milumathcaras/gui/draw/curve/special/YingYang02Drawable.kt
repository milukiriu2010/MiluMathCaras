...
// 陰陽 01
// -------------------------------------------------------------------------------------
//   x = ±a*sqrt(t/(90/PI+t))*cos(t)
//   y = ±a*sqrt(t/(90/PI+t))*sin(t)
// -------------------------------------------------------------------------------------
// https://www.mathcurve.com/courbes2d/ornementales/ornementales.shtml
// -------------------------------------------------------------------------------------
// 2019.05.31
// -------------------------------------------------------------------------------------
class YingYang02Drawable: MyDrawable() {
    ...
    private fun createPath() {
        ...
        (0..360 step 1).forEach {
            ...
            val x = a*sqrt(t/(90f/PI.toFloat()+t))*cos1
            val y = a*sqrt(t/(90f/PI.toFloat()+t))*sin1
