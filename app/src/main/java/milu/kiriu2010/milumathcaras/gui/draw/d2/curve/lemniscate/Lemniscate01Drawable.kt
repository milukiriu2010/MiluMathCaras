package milu.kiriu2010.milumathcaras.gui.draw.d2.curve.lemniscate
...
// -------------------------------------------------------------------------------------
class Lemniscate01Drawable: MyDrawable() {
    ...
    private fun createPath() {
        ...
        (0..360 step 1).forEach {
            ...
            val x = a*cos/(1f+sin*sin)
            val y = a*sin*cos/(1f+sin*sin)
