...
// -----------------------------------------------------------------
class SierpinskiPentagon01Drawable: MyDrawable() {
    // -------------------------------------
    // 描画領域
    // -------------------------------------
    ...
    private fun calNextLevel(polygon0:Polygon, n: Int) {
        ...
        // -------------------------------------------------------------------------
        (0..4).forEach {
            val x = rC * MyMathUtil.cosf(it.toFloat()*72f)
            val y = rC * MyMathUtil.sinf(it.toFloat()*72f)
            val polygon = Polygon().apply {
    ...
    private class Polygon {
        ...
        var r: Float = 0f
            set(data: Float) {
                field = data
                (0..4).forEach {
                    val x = data*MyMathUtil.cosf(it.toFloat()*72f)
                    val y = data*MyMathUtil.sinf(it.toFloat()*72f)
