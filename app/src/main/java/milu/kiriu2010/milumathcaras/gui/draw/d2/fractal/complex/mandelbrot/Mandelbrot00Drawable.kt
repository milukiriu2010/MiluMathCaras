package milu.kiriu2010.milumathcaras.gui.draw.d2.fractal.complex.mandelbrot
...
class Mandelbrot00Drawable: MyDrawable() {
    ...
    private fun scanImagenary() {
        ...
        (dv until side.toInt() step dv).forEachIndexed { _, i ->
            ...
            // Y軸に平行なスケールを描画
            canvas.drawLine(i.toFloat(), 0f,i.toFloat(),side,scalePaint)
        }
