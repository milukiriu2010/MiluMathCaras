...
// -----------------------------------------------------------------
class SierpinskiStar01Drawable: MyDrawable() {
    // -------------------------------------
    // 描画領域
    // -------------------------------------
            ...
            set(data: Float) {
                ...
                (0..9).forEach {
                    ...
                    when (it%2) {
                        ...
                        1 -> {
                            d = 54f
                            rr = (3f-sqrt(5f))/2f*data
                        }
                    }

                    val x = rr*MyMathUtil.cosf(it.toFloat()*72f+d)
                    val y = rr*MyMathUtil.sinf(it.toFloat()*72f+d)
